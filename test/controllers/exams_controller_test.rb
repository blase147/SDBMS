...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { class: @exam.class, option: @exam.option, question: @exam.question, session: @exam.session, term: @exam.term } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { class: @exam.class, option: @exam.option, question: @exam.question, session: @exam.session, term: @exam.term } }
