...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create parent' do
    assert_difference('Parent.count') do
      post parents_url,
           params: { parent: { country: @parent.country, dateofbirth: @parent.dateofbirth, email: @parent.email,
                               firstname: @parent.firstname, lastname: @parent.lastname, lga: @parent.lga, occupation: @parent.occupation, phone: @parent.phone, photo: @parent.photo, state: @parent.state, street: @parent.street, title: @parent.title } }
    end
