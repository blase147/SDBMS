  ...
  test 'should create attendance' do
    assert_difference('Attendance.count') do
      post attendances_url,
           params: { attendance: { email: @attendance.email, firstname: @attendance.firstname, lastname: @attendance.lastname,
                                   other_names: @attendance.other_names, phone: @attendance.phone, photo: @attendance.photo } }
    end
