...
class TextbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create textbook' do
    assert_difference('Textbook.count') do
      post textbooks_url,
           params: { textbook: { authur: @textbook.authur, description: @textbook.description, level: @textbook.level,
                                 publisher: @textbook.publisher, title: @textbook.title, year_of_publication: @textbook.year_of_publication } }
    end
