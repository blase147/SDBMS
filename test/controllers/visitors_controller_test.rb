...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create visitor' do
    assert_difference('Visitor.count') do
      post visitors_url,
           params: { visitor: { email: @visitor.email, enquiry: @visitor.enquiry, firstname: @visitor.firstname,
                                lastname: @visitor.lastname, other_names: @visitor.other_names, phone: @visitor.phone } }
    end
