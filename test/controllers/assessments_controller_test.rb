  ...
  test 'should create assessment' do
    assert_difference('Assessment.count') do
      post assessments_url,
           params: { assessment: { academic_session: @assessment.academic_session, class: @assessment.class,
                                   subject: @assessment.subject, term: @assessment.term, type: @assessment.type } }
    end
